...
export default function LeadsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold" style={{ color: "var(--th-text)" }}>Leads</h1>
        <p className="mt-1" style={{ color: "var(--th-text-secondary)" }}>Manage and track your lead pipeline.</p>
      </div>
